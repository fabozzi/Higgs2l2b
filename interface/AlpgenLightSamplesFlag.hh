...
/// Modified for CMS usage by Miguel Vidal (26/X/2010)

#ifndef __ALPGENLIGHTSAMPLESFLAG_HH
#define __ALPGENLIGHTSAMPLESFLAG_HH
...
class AlpgenLightSamplesFlag : public edm::EDProducer {
...
public:
  ...
  /// Destructor.
  ~AlpgenLightSamplesFlag (void);

  /// Constructor.
  explicit AlpgenLightSamplesFlag (const edm::ParameterSet&);
