...
#ifndef __ALPGENBBSAMPLESFLAG_HH
#define __ALPGENBBSAMPLESFLAG_HH
...
class AlpgenBBSamplesFlag : public edm::EDProducer {
...
public:
  ...
  /// Destructor.
  ~AlpgenBBSamplesFlag (void);

  /// Constructor.
  explicit AlpgenBBSamplesFlag (const edm::ParameterSet&);
